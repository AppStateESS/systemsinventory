...
export default class PC extends Device {

  render() {
    const {device, update} = this.props
    return (
      <div>
        <Network {...this.props} secondIp={true} secondMac={true} vlan={true}/>
        <hr/>
        <UserInformation {...this.props}/>
        <hr/>
        <fieldset>
          <legend>Build specifications</legend>
          <div className="row">
          ...
          <div className="row">
            ...
            <div className="col-sm-4">
              ...
              <div>
                <BigCheckbox
                  checked={device.docking_stand === 1}
                  handle={update.bind(null, 'docking_stand', device.docking_stand === 1
                  ? 0
                  : 1)}
                  label="Docking stand"/>
              </div>
